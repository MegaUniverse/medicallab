        ...
        data = data
            ...
            .map( usuario => {
                return `<tr>
                        ...
                        <td>${usuario.fone}</td>
                        <td>
                            <button class='verde' onclick='vizualizar("cadastro",false,${usuario.id})'>Visualizar</button>
                            <button class='laranja' onclick='vizualizar("cadastro",false,${usuario.id})'>Editar</button>
